...
export default {
  ...
  data() {
    return {
      avatar: 'https://sudoshivam.me/images/profile.png',
      name: 'github.com/sudoshivam',
      mode: 'dark',
      description: 'Programmer who likes creating new things with his skills.',
      content: `Hi! 👋<br/> If you want to use this template to set up your portfolio + blog follow the steps on github page.<br/><br/>
